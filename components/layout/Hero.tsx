...
export default function Hero() {
    return (
        <section className="h-screen relative flex md:flex-row flex-col justify-center items-center font-archivo">
            <div className="flex-1 w-full px-10 flex md:flex-row flex-col justify-center align-middle pt-10 md:pt-0 bg-[url('/hero-background.webp')] bg-cover bg-center shadow-shadow border-border h-screen">
                {/* <Image
            ...
            <div className='flex-1 p-2 justify-center items-center md:items-start flex flex-col gap-4 text-center md:text-left'>
                <h2 className='text-6xl md:text-8xl font-bold text-main-foreground border-border shadow-shadow'>Hub KE</h2>
                <p>
