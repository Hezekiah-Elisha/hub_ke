            ...
            <div className="flex flex-col h-full">
                <CardHeader className="border-b-[3px] border-border pb-4 bg-background/25">
                    <div className="flex flex-col gap-2">
                        <span className={`w-fit text-[10px] font-black uppercase border-[2px] border-border px-2 py-0.5 shadow-[2px_2px_0px_0px_var(--border)] rounded-xs ${badgeColor} text-black select-none`}>
                            {category}
                        </span>
                    ...
                    <CardAction>
                        <Link 
                            href={link} 
                            target="_blank" 
                            className="flex flex-row justify-center items-center gap-1.5 text-xs font-black uppercase tracking-wider bg-secondary-background border-[2px] border-border px-2.5 py-1 shadow-[2px_2px_0px_0px_var(--border)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[0px_0px_0px_0px_var(--border)] transition-all rounded-base"
                        >
